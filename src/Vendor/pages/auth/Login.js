...
function Login() {
  return (
    <div className="flex items-center">
      {/* Left Side */}
      <div className="w-1/2  px-52 bg-gray-900  h-screen">
        ...
        <form>
          <div className="mb-4">
            ...
            <input
              type="email"
              id="email"
              className="w-full p-3 border rounded mt-1 focus:outline-none bg-transparent focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
        ...
        <button className="w-full flex items-center text-gray-300 justify-center py-3 mb-4 border rounded-md font-semibold text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500">
          <img
        ...
        <button className="w-full flex items-center justify-center text-gray-300 py-3 mb-4 border rounded-md font-semibold text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500">
      ...
      <div className="w-1/2 h-screen">
        <img
          src="https://www.metlifestadium.com/images/default-source/corporate/corporate-event-page.jpg?sfvrsn=38a29478_2"
