...
import plays1 from '../images/plays/plays1.jpg'
...
export default function Plays() {
    register()
    const slideimg=[plays1,hdevent12,hdevent14]
    ...
    {/* <div className='ml-[80px] mr-[80px] bg-[rgba(245,245,245,1)] '> */}
      ...
      <div className='flex'>
        ...
        <div className="  w-[270px] flex flex-wrap  gap-6">
          ...
          <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black  '>New Year Parties</p>
            ...
            <div className='flex justify-between border-2 rounded-lg pl-2 pr-3 p-1 w-[280px] mt-[-20px]' >
                ...
                <p className='ml-[-50px] ' onClick={toggleContentGenres}>Genres</p>
                <p className='hover:text-[rgba(255,67,67,1)]'>Clear</p>
            </div>
            {isOpenGenres && (
                  <div className=''>
        <div className="  w-[270px] flex flex-wrap  gap-6">
          <p className='text-[rgba(255,67,67,1)] w-auto font-roboto leading-[20px] border  border-black '>Drama</p>
          <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black   '>Comedy</p>
          <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black   '> Classic</p>
          <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black   '> Romantic</p>
          <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black   '> Adventure</p>
        </div>
          </div>
      )}
            </div>
        ...
        <div className='mt-[40px]'>
            <div>
        <p className=' font-roboto font-semibold text-[25px] leading-[37.5px] '>Plays in {labelText}</p>
        </div>
        <div className='flex gap-5 p-1   '>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2   '>Theatre</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2  '>Story Telling</p>
