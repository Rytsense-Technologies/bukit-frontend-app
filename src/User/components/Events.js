...
export default function Events() {
    ...
    register()
    const slideimg=[hdevent13,hdevent12,hdevent14]
      ...
      <div className='flex'>
        ...
        />
            ...
            <div className='flex justify-between border-2 rounded-lg pl-2 pr-3 p-1 w-[280px]' >
                <span onClick={toggleContentLanguage}> <FontAwesomeIcon icon={isOpenLanguage ? faChevronUp : faChevronDown} /></span>
                <p className='ml-[-100px] ' onClick={toggleContentLanguage}>Language</p>
                <p className='hover:text-[rgba(255,67,67,1)]'>Clear</p>
            </div>
            {isOpenLanguage && (
                  <div className=''>
        <div className="  w-[270px] flex flex-wrap  gap-6">
          {/* <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black-500  '>English</p> */}
          <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black  '>English</p>
          <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black   '>Tamil</p>
          <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black   '>Hindi</p>
          <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black  '>Telugu</p>
          <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black   '>Malayalam</p>
          <p className='text-[rgba(255,67,67,1)]  font-roboto leading-[20px] border  border-black  '>Bengali</p>
        </div>
          </div>
      )}
        ...
        <div className='mt-[40px]'>
            <div>
        <p className=' font-roboto font-semibold text-[25px] leading-[37.5px] '>Events in {labelText}</p>
        </div>
        <div className='flex gap-5 p-1   '>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2'>Comedy shows</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2  '>Music shows</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2 '>Workshops</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2  '>Performances</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-3 pr-3  '>Kids</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2  '>Conferences</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2  '>Meetups</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2  '>Screening</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2  '>Talks</p>
