...
import activities1 from '../images/activities/activities1.jpg'
...
export default function Activities() {
    register()
    const slideimg=[activities1,hdevent12,hdevent14]
    ...
    {/* <div className='ml-[80px] mr-[80px] bg-[rgba(245,245,245,1)] '> */}
      ...
      <div className='flex'>
        ...
        <div className='mt-[40px]'>
            <div>
        <p className=' font-roboto font-semibold text-[25px] leading-[37.5px] '>Activities in {labelText}</p>
        </div>
        <div className='flex gap-5 p-1   '>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2   '>Amusement Parks</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2  '>Nightlife</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2   '>Gaming</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2   '>Adventure</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2 '>Tourist Attractions</p>
        <p className=' font-roboto leading-[37.5px] border-[1px]  border-white  rounded-lg pl-2 pr-2  '>Christmas Celebrations</p>
